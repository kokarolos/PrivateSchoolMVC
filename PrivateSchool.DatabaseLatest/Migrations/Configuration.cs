namespace PrivateSchool.DatabaseLatest.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<m_Database>
    {
        ...
        protected override void Seed(m_Database context)
        {
            ...
            var a12 = new Assignment() { Description = "ConsoleApplication", SubDate = new DateTime(2020, 8, 22), PhotoUrl = "https://dummyimage.com/600x400/000/fff&text=AS12" };
